...
MACHINE_METADATA = {
    ...
    "lassen" : (["module --force purge", "module load git gcc/8.3.1 cuda/10.1.243 cmake/3.16.8 spectrum-mpi python/3.7.2", "export LLNL_USE_OMPI_VARS='y'"],
                 ["mpicxx","mpifort","mpicc"],
                  "bsub -Ip -qpdebug",
                  ""),
    "lassen-cpu" : (["module --force purge", "module load gcc/8.3.1", "spack compiler find", "spack load e3sm-scream%gcc@8.3.1"],
                    ["mpicxx","mpifort","mpicc"],
                    "bsub -Ip -qpdebug",
                    ""),
    "lassen-gpu" : (["module --force purge", "module load gcc/8.3.1", "spack compiler find", "spack load e3sm-scream%gcc@8.3.1"],
                    ["mpicxx","mpifort","mpicc"],
                    "bsub -Ip -qpdebug",
                    ""),
