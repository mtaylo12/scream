...
macro (CreateCsmShareTarget)
  ...
  # If we didn't already parse this script, create the target
  if (NOT TARGET csm_share)

    # For CIME builds, simply wrap the lib built by CIME in a cmake tgt
    if (SCREAM_CIME_BUILD)
      ...
      # For SCREAM standalone, create a normal library target
      ...
      # FORTRAN_SOURCE lists the source files we want to build that
      # do NOT need to be run through the genf90 perl script.
      # We will append to this list below with our processed genf90 files.
      set (FORTRAN_SOURCE
      ...
      add_library(csm_share ${share_sources} ${CMAKE_BINARY_DIR}/csm_share)
      set_target_properties(csm_share PROPERTIES Fortran_MODULE_DIRECTORY ${CMAKE_BINARY_DIR}/csm_share/csm_share_modules)
