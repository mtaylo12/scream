...
void SHOCMacrophysics::initialize_impl (const RunType /* run_type */)
{
  ...
  add_postcondition_check<FieldWithinIntervalCheck>(get_field_out("qv"),1e-13,0.2,true);
...
//ASD  add_postcondition_check<FieldWithinIntervalCheck>(get_field_out("pbl_height"),0.0,3000.0,false);
